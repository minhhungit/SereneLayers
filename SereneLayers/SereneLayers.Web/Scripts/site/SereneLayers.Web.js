...
(function (SereneLayers) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return SereneLayers.LanguageList.getValue();
            };
    ...
    })(Northwind = SereneLayers.Northwind || (SereneLayers.Northwind = {}));
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
    var Northwind;
    (function (Northwind) {
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(SereneLayers.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(SereneLayers.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (SereneLayers) {
    ...
    })(Common = SereneLayers.Common || (SereneLayers.Common = {}));
})(SereneLayers || (SereneLayers = {}));
...
(function (SereneLayers) {
    ...
    (function (Northwind) {
        ...
        }(SereneLayers.Common.GridEditorDialog));
...
(function (SereneLayers) {
    ...
    (function (Northwind) {
        ...
        }(SereneLayers.Common.GridEditorBase));
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SereneLayers.BasicProgressDialog();
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLayers.Common.BulkServiceAction));
        BasicSamples.OrderBulkAction = OrderBulkAction;
    })(BasicSamples = SereneLayers.BasicSamples || (SereneLayers.BasicSamples = {}));
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
    var Northwind;
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(SereneLayers.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SereneLayers.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SereneLayers.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (SereneLayers) {
    ...
    })(Membership = SereneLayers.Membership || (SereneLayers.Membership = {}));
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
    var Membership;
...
(function (SereneLayers) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('SereneLayers');
    })(ScriptInitialization = SereneLayers.ScriptInitialization || (SereneLayers.ScriptInitialization = {}));
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
    var Common;
...
(function (SereneLayers) {
    ...
    })(Administration = SereneLayers.Administration || (SereneLayers.Administration = {}));
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
    var Administration;
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return SereneLayers.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = SereneLayers.BasicSamples || (SereneLayers.BasicSamples = {}));
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return SereneLayers.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return SereneLayers.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = SereneLayers.BasicSamples || (SereneLayers.BasicSamples = {}));
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
...
(function (SereneLayers) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'SereneLayers.Northwind.Entities.Gender');
    })(Northwind = SereneLayers.Northwind || (SereneLayers.Northwind = {}));
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
...
(function (SereneLayers) {
    ...
    SereneLayers.BasicProgressDialog = BasicProgressDialog;
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
    var DialogUtils;
    ...
    })(DialogUtils = SereneLayers.DialogUtils || (SereneLayers.DialogUtils = {}));
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
    var Common;
...
(function (SereneLayers) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SereneLayers.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SereneLayers.LanguageList || (SereneLayers.LanguageList = {}));
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
    var Common;
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SereneLayers.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SereneLayers.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SereneLayers.Northwind.SalesByCategoryService.baseUrl; };
            /**
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLayers.Northwind.SupplierGrid));
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLayers.Northwind.ProductGrid));
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SereneLayers.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SereneLayers.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SereneLayers.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SereneLayers.Northwind.ProductService.baseUrl; };
    ...
    (function (BasicSamples) {
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                var fld = SereneLayers.Northwind.OrderRow.Fields;
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = SereneLayers.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
        ...
        }(SereneLayers.Northwind.OrderGrid));
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SereneLayers.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SereneLayers.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SereneLayers.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SereneLayers.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, SereneLayers.Northwind.OrderRow.Fields.ShipCountry);
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SereneLayers.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SereneLayers.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SereneLayers.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SereneLayers.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = SereneLayers.Northwind.ProductRow.Fields;
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLayers.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SereneLayers.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLayers.Northwind.OrderDetailsEditor));
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SereneLayers.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SereneLayers.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SereneLayers.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SereneLayers.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new SereneLayers.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = SereneLayers.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(SereneLayers.Northwind.OrderDetailDialog));
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SereneLayers.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SereneLayers.Northwind.CustomerDialog));
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLayers.Northwind.CustomerGrid));
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return SereneLayers.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return SereneLayers.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return SereneLayers.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return SereneLayers.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return SereneLayers.Northwind.OrderService.baseUrl; };
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLayers.Northwind.SupplierDialog));
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SereneLayers.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SereneLayers.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SereneLayers.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SereneLayers.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SereneLayers.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SereneLayers.Northwind.OrderService.baseUrl; };
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLayers.Northwind.OrderDialog));
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    SereneLayers.Northwind.CategoryService.Retrieve({
        ...
        }(SereneLayers.Northwind.CategoryDialog));
...
(function (SereneLayers) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLayers.Northwind.CategoryGrid));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SereneLayers.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SereneLayers.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SereneLayers.Northwind.OrderDialog();
                        ...
                        var chai = SereneLayers.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SereneLayers.Northwind.EmployeeRow.getLookup().items
...
(function (SereneLayers) {
    ...
    })(Authorization = SereneLayers.Authorization || (SereneLayers.Authorization = {}));
})(SereneLayers || (SereneLayers = {}));
var SereneLayers;
(function (SereneLayers) {
    var Administration;
...
//# sourceMappingURL=SereneLayers.Web.js.map